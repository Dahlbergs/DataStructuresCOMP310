...
public class LabOneMain {
	 ...
	 */
		GroceryItem milk = new GroceryItem(0.0, 0.2, 1.0);
    	GroceryItem bread = new GroceryItem(0.0, 1.0, 0.1);
    	GroceryItem eggs = new GroceryItem(0.8, 0.0, 0.4);
    	GroceryItem sugar = new GroceryItem(0.0, 0.0, 0.8);
    	GroceryItem tomato = new GroceryItem(0.0, 0.8, 0.2);
    	GroceryItem butter = new GroceryItem(0.0, 0.3, 0.4);
    	GroceryItem chips = new GroceryItem(1.0, 0.0, 0.1);
    	GroceryItem cheese = new GroceryItem(0.0, 0.0, 0.5);
