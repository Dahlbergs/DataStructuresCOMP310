	...
	public Bagger(LinkedBag<GroceryItem> emptyBag, GroceryItem[] groceryList) {
		...
		while(i < groceryList.length){
				if(groceryList[i].getBreakable() > groceryList[i+1].getBreakable())
				{
					...
					GroceryItem temp = new GroceryItem(groceryList[i].getBreakable(), groceryList[i].getSquishable(), groceryList[i].getWeight());
					...
					System.out.println("Break: " + groceryList[i].getBreakable() + " " + "Squish: " + groceryList[i].getSquishable() + " " + "Weight: " + groceryList[i].getWeight());
